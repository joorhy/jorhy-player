...
{
	int width, height;
	surface->screen = SDL_CreateWindow("", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 800, 600, /*SDL_WINDOW_FULLSCREEN |*/ SDL_WINDOW_OPENGL);
...
{
	SDL_UpdateYUVTexture(surface->texture, &surface->video[index], (const Uint8 *)decoder->picture->data[0], decoder->picture->linesize[0],
